...
for(int kte=0;kte<R_E+1;kte++){    
  for(int jte=0;jte<R_E+1;jte++){  
    ...
    LIST_X[NB_SPH]=ite*L_E;LIST_Y[NB_SPH]=jte*L_E;LIST_Z[NB_SPH]=kte*L_E;LIST_R[NB_SPH]=R_SPH;NB_SPH++;
...
for(int kte=0;kte<R_E+1;kte++){    
  for(int jte=0;jte<R_E;jte++){  
    ...
    LIST_X[NB_SPH]=L_E/2.+ite*L_E;LIST_Y[NB_SPH]=L_E/2.+jte*L_E;LIST_Z[NB_SPH]=kte*L_E;LIST_R[NB_SPH]=R_SPH;NB_SPH++;
...
for(int kte=0;kte<R_E;kte++){    
  for(int jte=0;jte<R_E;jte++){  
    ...
    LIST_X[NB_SPH]=ite*L_E;LIST_Y[NB_SPH]=L_E/2.+jte*L_E;LIST_Z[NB_SPH]=L_E/2.+kte*L_E;LIST_R[NB_SPH]=R_SPH;NB_SPH++;
...
for(int kte=0;kte<R_E;kte++){    
  for(int jte=0;jte<R_E+1;jte++){  
    ...
    LIST_X[NB_SPH]=L_E/2.+ite*L_E;LIST_Y[NB_SPH]=jte*L_E;LIST_Z[NB_SPH]=L_E/2.+kte*L_E;LIST_R[NB_SPH]=R_SPH;NB_SPH++;
